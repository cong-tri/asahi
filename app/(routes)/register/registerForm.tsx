...
const listJobs: ListSelect[] = [
    {
        value: "sample",
        label: <h1 className="text-xl text-green-600">Chọn công việc</h1>,
    },
    {
        value: "no_job",
        label: (
            <h1 className="text-xl text-green-600">Chưa có việc làm/ Thất nghiệp</h1>
        ),
    },
    {
        value: "work_at_factory",
        label: <h1 className="text-xl text-green-600">Đang làm tại nhà máy</h1>,
    },
    {
    ...
    },
    {
        ...
        label: <h1 className="text-xl text-green-600">Đang làm tại văn phòng</h1>,
    },
    {
...
const listPrograms: ListSelect[] = [
    {
        value: "sample",
        label: <h1 className="text-xl text-green-600">Chọn chương trình</h1>,
    },
    {
        value: "program_1-3-5_year_interns_work_in_Japan",
        label: (
            <h1 className="text-xl text-green-600">Thực tập sinh 1 - 3 - 5 năm làm việc tại Nhật</h1>
        ),
    },
    {
        value: "program_Study_Abroad_Program_study_abroad_in_Japan",
        label: <h1 className="text-xl text-green-600">Chương trình Lưu học (du học) Nhật Bản</h1>,
    },
    {
    ...
    },
    {
        ...
        label: <h1 className="text-xl text-green-600">Khóa tiếng Nhật các trình độ N4, N3, N2</h1>,
    },
    {
...
const RegisterForm = () => {
    const onFinish: FormProps<Register>["onFinish"] = (values) => {
        ...
        <div className="py-8">
            <Row align={"middle"} justify={"center"}>
                <Col span={13}>
                    ...
                    <h1 className="text-2xl text-red-500 text-end my-3 italic">
                    ...
                    <div className="my-5">
                        <Form
                            ...
                            onFinish={onFinish}
                        >
                            <h1 className="text-xl mb-2 pl-6">
                            ...
                            <h1 className="text-xl mb-2 pl-6">Địa chỉ Email</h1>
                            <Form.Item<Register>
                                name="email"
                                rules={[
                                    {
